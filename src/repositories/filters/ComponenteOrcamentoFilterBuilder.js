...
import ComponenteOrcamentoRepository from '../ComponenteOrcamentoRepository.js';
...
class ComponenteOrcamentoFilterBuilder {
    constructor() {
        this.filtros = {};
        this.componenteOrcamentoRepository = new ComponenteOrcamentoRepository();
        this.componenteOrcamentoModel = ComponenteOrcamentoModel;
    };
